...
pub fn deinit(self: *const FileBuffer) void {
...
pub fn getNewline(self: *const FileBuffer) []const u8 {
    for (self.newline, 0..) |c, i| {
        if (c == 0) return self.newline[0..i];
    } else return &self.newline;
}

pub fn size(self: *const FileBuffer) usize {
    var result: usize = 0;
...
pub fn newlineCount(self: *const FileBuffer) usize {
    var result: usize = 0;
    for (self.pieces.items) |piece| {
...
pub fn lineCount(self: *const FileBuffer) usize {
    return self.newlineCount() + 1;
}

pub fn getContent(self: *const FileBuffer, allocator: Allocator) !ArrayList(u8) {
...
pub fn getLineIndex(self: *const FileBuffer, line: usize) !usize {
...
fn findPiece(self: *const FileBuffer, index: usize) PieceIndex {
...
pub fn insert(self: *FileBuffer, index: usize, content: []const u8) !void {
...
pub fn insertLine(self: *FileBuffer, line: usize, content: []const u8) !void {
    _ = content;
    _ = line;
    _ = self;
    // TODO
...
pub fn delete(self: *FileBuffer, index: usize, len: usize) !void {
    // TODO
    _ = len;
    _ = index;
    _ = self;
...
pub fn getDelete(self: *FileBuffer, index: usize, len: usize) !ArrayList(u8) {
    // TODO
    _ = len;
    _ = index;
    _ = self;
...
pub fn deleteLine(self: *FileBuffer, line: usize) !void {
    // TODO
    _ = line;
    _ = self;
}

pub fn getDeleteLine(self: *FileBuffer, line: usize) !ArrayList(u8) {
    // TODO
    _ = line;
    _ = self;
}
